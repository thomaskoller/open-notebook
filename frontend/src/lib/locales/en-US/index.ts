export const enUS = {
  ...
  sources: {
    ...
    insightGenerationFailed: "Insight generation failed",
    insightGenerationTimedOut: "Insight generation is taking longer than expected. Check background jobs for progress.",
    editNote: "Edit note",
  ...
  jobs: {
    ...
    noneActive: "Nothing running right now",
    empty: "No background jobs yet",
    attempt: "attempt {{count}}",
    unknownCommand: "Background job",
    cancelled: "Job cancelled",
    cancelledDesc: "The job was removed from the queue.",
    cancelFailed: "Could not cancel this job - it has already started or finished.",
    status: {
      queued: "Queued",
      running: "Running",
      retrying: "Retrying",
    ...
    commands: {
      process_source: "Processing source",
      run_transformation: "Running transformation",
      embed_source: "Embedding source",
      embed_note: "Embedding note",
      embed_insight: "Embedding insight",
      create_insight: "Creating insight",
      rebuild_embeddings: "Rebuilding embeddings",
      generate_podcast: "Generating podcast",
    },
    progress: {
      extracting: "Extracting content",
      transforming: "Running transformations",
      saving: "Saving",
      resolving_profiles: "Resolving profiles",
      generating_outline: "Generating outline",
      generating_transcript: "Writing transcript",
      combining_audio: "Combining audio",
      generating_audio: "Generating audio",
      queueing_embeddings: "Queueing embedding jobs",
    },
  },
}
