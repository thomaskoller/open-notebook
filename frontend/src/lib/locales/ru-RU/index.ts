...
export const ruRU = {
  ...
  sources: {
    ...
    insightGenerationFailed: "Не удалось создать инсайт",
    insightGenerationTimedOut: "Создание инсайта занимает больше времени, чем обычно. Проверьте фоновые задачи.",
  ...
  jobs: {
    ...
    activeCount: "{{count}} в работе",
    noneActive: "Сейчас ничего не выполняется",
    empty: "Фоновых задач пока нет",
    attempt: "попытка {{count}}",
    unknownCommand: "Фоновая задача",
    cancelled: "Задача отменена",
    cancelledDesc: "Задача удалена из очереди.",
    cancelFailed: "Не удалось отменить задачу — она уже началась или завершилась.",
    status: {
      queued: "В очереди",
      running: "Выполняется",
      retrying: "Повтор",
    ...
    commands: {
      process_source: "Обработка источника",
      run_transformation: "Выполнение преобразования",
      embed_source: "Векторизация источника",
      embed_note: "Векторизация заметки",
      embed_insight: "Векторизация инсайта",
      create_insight: "Создание инсайта",
      rebuild_embeddings: "Перестроение векторов",
      generate_podcast: "Создание подкаста",
    },
    progress: {
      extracting: "Извлечение содержимого",
      transforming: "Выполнение преобразований",
      saving: "Сохранение",
      resolving_profiles: "Разрешение профилей",
      generating_outline: "Создание плана",
      generating_transcript: "Написание транскрипта",
      combining_audio: "Объединение аудио",
      generating_audio: "Создание аудио",
      queueing_embeddings: "Постановка задач векторизации в очередь",
    },
  },
