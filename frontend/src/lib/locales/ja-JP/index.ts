...
export const jaJP = {
  ...
  sources: {
    ...
    insightGenerationFailed: "インサイトの生成に失敗しました",
    insightGenerationTimedOut: "インサイトの生成に想定より時間がかかっています。バックグラウンドジョブを確認してください。",
    editNote: "ノートを編集",
    createNote: "ノートを作成",
    addTitle: "タイトルを追加...",
    untitledNote: "無題のノート",
  ...
  jobs: {
    ...
    noneActive: "現在実行中のものはありません",
    empty: "バックグラウンドジョブはまだありません",
    attempt: "{{count}} 回目の試行",
    unknownCommand: "バックグラウンドジョブ",
    cancelled: "ジョブをキャンセルしました",
    cancelledDesc: "ジョブをキューから削除しました。",
    cancelFailed: "このジョブはキャンセルできません。すでに開始または完了しています。",
    status: {
      queued: "待機中",
      running: "実行中",
      retrying: "再試行中",
    ...
    commands: {
      process_source: "ソースを処理中",
      run_transformation: "変換を実行中",
      embed_source: "ソースを埋め込み中",
      embed_note: "ノートを埋め込み中",
      embed_insight: "インサイトを埋め込み中",
      create_insight: "インサイトを作成中",
      rebuild_embeddings: "埋め込みを再構築中",
      generate_podcast: "ポッドキャストを生成中",
    },
    progress: {
      extracting: "コンテンツを抽出中",
      transforming: "変換を実行中",
      saving: "保存中",
      resolving_profiles: "プロファイルを解決中",
      generating_outline: "構成を生成中",
      generating_transcript: "台本を作成中",
      combining_audio: "音声を結合中",
      generating_audio: "音声を生成中",
      queueing_embeddings: "埋め込みジョブをキューに追加中",
    },
  },
