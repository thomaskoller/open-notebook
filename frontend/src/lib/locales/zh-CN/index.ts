...
export const zhCN = {
  ...
  sources: {
    ...
    insightGenerationFailed: "洞察生成失败",
    insightGenerationTimedOut: "洞察生成耗时超出预期。请查看后台任务。",
    editNote: "编辑笔记",
    createNote: "创建笔记",
    addTitle: "添加标题...",
    untitledNote: "无标题笔记",
  ...
  jobs: {
    ...
    noneActive: "当前没有正在运行的任务",
    empty: "暂无后台任务",
    attempt: "第 {{count}} 次尝试",
    unknownCommand: "后台任务",
    cancelled: "任务已取消",
    cancelledDesc: "任务已从队列中移除。",
    cancelFailed: "无法取消此任务 — 它已开始或已结束。",
    status: {
      queued: "排队中",
      running: "进行中",
      retrying: "重试中",
    ...
    commands: {
      process_source: "正在处理来源",
      run_transformation: "正在执行转换",
      embed_source: "正在嵌入来源",
      embed_note: "正在嵌入笔记",
      embed_insight: "正在嵌入洞察",
      create_insight: "正在创建洞察",
      rebuild_embeddings: "正在重建嵌入",
      generate_podcast: "正在生成播客",
    },
    progress: {
      extracting: "正在提取内容",
      transforming: "正在执行转换",
      saving: "正在保存",
      resolving_profiles: "正在解析配置",
      generating_outline: "正在生成大纲",
      generating_transcript: "正在撰写脚本",
      combining_audio: "正在合并音频",
      generating_audio: "正在生成音频",
      queueing_embeddings: "正在排队嵌入任务",
    },
  },
