...
export const zhTW = {
  ...
  sources: {
    ...
    insightGenerationFailed: "洞察產生失敗",
    insightGenerationTimedOut: "洞察產生耗時超出預期。請查看背景工作。",
    editNote: "編輯筆記",
    createNote: "新增筆記",
    addTitle: "新增標題...",
    untitledNote: "無標題筆記",
  ...
  jobs: {
    ...
    noneActive: "目前沒有正在執行的工作",
    empty: "尚無背景工作",
    attempt: "第 {{count}} 次嘗試",
    unknownCommand: "背景工作",
    cancelled: "工作已取消",
    cancelledDesc: "工作已從佇列中移除。",
    cancelFailed: "無法取消此工作 — 它已開始或已結束。",
    status: {
      queued: "排隊中",
      running: "進行中",
      retrying: "重試中",
    ...
    commands: {
      process_source: "正在處理來源",
      run_transformation: "正在執行轉換",
      embed_source: "正在嵌入來源",
      embed_note: "正在嵌入筆記",
      embed_insight: "正在嵌入洞察",
      create_insight: "正在建立洞察",
      rebuild_embeddings: "正在重建嵌入",
      generate_podcast: "正在產生 Podcast",
    },
    progress: {
      extracting: "正在擷取內容",
      transforming: "正在執行轉換",
      saving: "正在儲存",
      resolving_profiles: "正在解析設定檔",
      generating_outline: "正在產生大綱",
      generating_transcript: "正在撰寫腳本",
      combining_audio: "正在合併音訊",
      generating_audio: "正在產生音訊",
      queueing_embeddings: "正在排入嵌入工作",
    },
  },
