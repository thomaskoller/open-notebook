...
export const bnIN = {
  ...
  sources: {
    ...
    insightGenerationFailed: "অন্তর্দৃষ্টি তৈরি ব্যর্থ হয়েছে",
    insightGenerationTimedOut: "অন্তর্দৃষ্টি তৈরি হতে প্রত্যাশার চেয়ে বেশি সময় লাগছে। ব্যাকগ্রাউন্ড কাজ দেখুন।",
  ...
  jobs: {
    ...
    activeCount: "{{count}}টি চলমান",
    noneActive: "এই মুহূর্তে কিছুই চলছে না",
    empty: "এখনও কোনো ব্যাকগ্রাউন্ড কাজ নেই",
    attempt: "প্রচেষ্টা {{count}}",
    unknownCommand: "ব্যাকগ্রাউন্ড কাজ",
    cancelled: "কাজ বাতিল করা হয়েছে",
    cancelledDesc: "কাজটি সারি থেকে সরানো হয়েছে।",
    cancelFailed: "এই কাজটি বাতিল করা যায়নি - এটি ইতিমধ্যে শুরু বা শেষ হয়ে গেছে।",
    status: {
      queued: "সারিতে",
      running: "চলছে",
    ...
    commands: {
      process_source: "উৎস প্রক্রিয়া করা হচ্ছে",
      run_transformation: "রূপান্তর চালানো হচ্ছে",
      embed_source: "উৎস এম্বেড করা হচ্ছে",
      embed_note: "নোট এম্বেড করা হচ্ছে",
      embed_insight: "অন্তর্দৃষ্টি এম্বেড করা হচ্ছে",
      create_insight: "অন্তর্দৃষ্টি তৈরি হচ্ছে",
      rebuild_embeddings: "এম্বেডিং পুনর্নির্মাণ হচ্ছে",
      generate_podcast: "পডকাস্ট তৈরি হচ্ছে",
    },
    progress: {
      extracting: "কনটেন্ট নিষ্কাশন করা হচ্ছে",
      transforming: "রূপান্তর চালানো হচ্ছে",
      saving: "সংরক্ষণ করা হচ্ছে",
      resolving_profiles: "প্রোফাইল নির্ধারণ করা হচ্ছে",
      generating_outline: "রূপরেখা তৈরি হচ্ছে",
      generating_transcript: "ট্রান্সক্রিপ্ট লেখা হচ্ছে",
      combining_audio: "অডিও একত্র করা হচ্ছে",
      generating_audio: "অডিও তৈরি হচ্ছে",
      queueing_embeddings: "এম্বেডিং কাজ সারিতে দেওয়া হচ্ছে",
    },
  },
