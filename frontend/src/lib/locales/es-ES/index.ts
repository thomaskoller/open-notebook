...
export const esES = {
  ...
  sources: {
    ...
    insightGenerationFailed: "Error al generar el insight",
    insightGenerationTimedOut: "La generación del insight está tardando más de lo esperado. Consulta las tareas en segundo plano.",
  ...
  jobs: {
    ...
    noneActive: "Nada en ejecución ahora mismo",
    empty: "Aún no hay tareas en segundo plano",
    attempt: "intento {{count}}",
    unknownCommand: "Tarea en segundo plano",
    cancelled: "Tarea cancelada",
    cancelledDesc: "La tarea se eliminó de la cola.",
    cancelFailed: "No se pudo cancelar esta tarea: ya ha comenzado o terminado.",
    status: {
      queued: "En cola",
    ...
    commands: {
      process_source: "Procesando fuente",
      run_transformation: "Ejecutando transformación",
      embed_source: "Incrustando fuente",
      embed_note: "Incrustando nota",
      embed_insight: "Incrustando insight",
      create_insight: "Creando insight",
      rebuild_embeddings: "Reconstruyendo incrustaciones",
      generate_podcast: "Generando pódcast",
    },
    progress: {
      extracting: "Extrayendo contenido",
      transforming: "Ejecutando transformaciones",
      saving: "Guardando",
      resolving_profiles: "Resolviendo perfiles",
      generating_outline: "Generando el esquema",
      generating_transcript: "Escribiendo la transcripción",
      combining_audio: "Combinando el audio",
      generating_audio: "Generando audio",
      queueing_embeddings: "Encolando tareas de incrustación",
    },
  },
