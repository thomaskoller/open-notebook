...
export const frFR = {
  ...
  sources: {
    ...
    insightGenerationFailed: "Échec de la génération de l'insight",
    insightGenerationTimedOut: "La génération de l'insight prend plus de temps que prévu. Consultez les tâches en arrière-plan.",
  ...
  jobs: {
    ...
    noneActive: "Rien en cours pour le moment",
    empty: "Aucune tâche en arrière-plan pour l'instant",
    attempt: "tentative {{count}}",
    unknownCommand: "Tâche en arrière-plan",
    cancelled: "Tâche annulée",
    cancelledDesc: "La tâche a été retirée de la file d'attente.",
    cancelFailed: "Impossible d'annuler cette tâche : elle a déjà démarré ou s'est terminée.",
    status: {
    ...
    commands: {
      process_source: "Traitement de la source",
      run_transformation: "Exécution de la transformation",
      embed_source: "Vectorisation de la source",
      embed_note: "Vectorisation de la note",
      embed_insight: "Vectorisation de l'insight",
      create_insight: "Création de l'insight",
      rebuild_embeddings: "Reconstruction des vecteurs",
      generate_podcast: "Génération du podcast",
    },
    progress: {
      extracting: "Extraction du contenu",
      transforming: "Exécution des transformations",
      saving: "Enregistrement",
      resolving_profiles: "Résolution des profils",
      generating_outline: "Génération du plan",
      generating_transcript: "Rédaction de la transcription",
      combining_audio: "Assemblage de l'audio",
      generating_audio: "Génération de l'audio",
      queueing_embeddings: "Mise en file des vectorisations",
    },
  },
