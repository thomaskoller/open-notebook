...
export const ptBR = {
  ...
  sources: {
    ...
    insightGenerationFailed: "Falha ao gerar o insight",
    insightGenerationTimedOut: "A geração do insight está demorando mais que o esperado. Verifique as tarefas em segundo plano.",
  ...
  jobs: {
    ...
    noneActive: "Nada em execução no momento",
    empty: "Nenhuma tarefa em segundo plano ainda",
    attempt: "tentativa {{count}}",
    unknownCommand: "Tarefa em segundo plano",
    cancelled: "Tarefa cancelada",
    cancelledDesc: "A tarefa foi removida da fila.",
    cancelFailed: "Não foi possível cancelar esta tarefa - ela já começou ou terminou.",
    status: {
      queued: "Na fila",
      running: "Em execução",
      retrying: "Tentando novamente",
    ...
    commands: {
      process_source: "Processando fonte",
      run_transformation: "Executando transformação",
      embed_source: "Incorporando fonte",
      embed_note: "Incorporando nota",
      embed_insight: "Incorporando insight",
      create_insight: "Criando insight",
      rebuild_embeddings: "Reconstruindo incorporações",
      generate_podcast: "Gerando podcast",
    },
    progress: {
      extracting: "Extraindo conteúdo",
      transforming: "Executando transformações",
      saving: "Salvando",
      resolving_profiles: "Resolvendo perfis",
      generating_outline: "Gerando a estrutura",
      generating_transcript: "Escrevendo a transcrição",
      combining_audio: "Combinando o áudio",
      generating_audio: "Gerando áudio",
      queueing_embeddings: "Enfileirando tarefas de incorporação",
    },
  },
