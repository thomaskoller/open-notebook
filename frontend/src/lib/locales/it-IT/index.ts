...
export const itIT = {
  ...
  sources: {
    ...
    insightGenerationFailed: "Generazione dell'insight non riuscita",
    insightGenerationTimedOut: "La generazione dell'insight sta richiedendo più tempo del previsto. Controlla le attività in background.",
  ...
  jobs: {
    ...
    noneActive: "Al momento non è in esecuzione nulla",
    empty: "Nessuna attività in background",
    attempt: "tentativo {{count}}",
    unknownCommand: "Attività in background",
    cancelled: "Attività annullata",
    cancelledDesc: "L'attività è stata rimossa dalla coda.",
    cancelFailed: "Impossibile annullare questa attività: è già iniziata o terminata.",
    status: {
      queued: "In coda",
      running: "In esecuzione",
      retrying: "Nuovo tentativo",
    ...
    commands: {
      process_source: "Elaborazione della fonte",
      run_transformation: "Esecuzione della trasformazione",
      embed_source: "Incorporamento della fonte",
      embed_note: "Incorporamento della nota",
      embed_insight: "Incorporamento dell'insight",
      create_insight: "Creazione dell'insight",
      rebuild_embeddings: "Ricostruzione degli embedding",
      generate_podcast: "Generazione del podcast",
    },
    progress: {
      extracting: "Estrazione del contenuto",
      transforming: "Esecuzione delle trasformazioni",
      saving: "Salvataggio",
      resolving_profiles: "Risoluzione dei profili",
      generating_outline: "Generazione della scaletta",
      generating_transcript: "Scrittura della trascrizione",
      combining_audio: "Unione dell'audio",
      generating_audio: "Generazione dell'audio",
      queueing_embeddings: "Accodamento delle attività di incorporamento",
    },
  },
